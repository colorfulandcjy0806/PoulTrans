...
from models.ResNet_RCNN.model_resnet50 import EncoderCNN, AttnDecoderRNN
...
from ContrastiveMultiModalLoss import EnhancedLoss
seed = 1234
...
def main(args):
    global best_accumulate_bleu4, epoch, epochs_since_improvement, checkpoint, start_epoch, fine_tune_encoder, data_name, vocab, bleu1, bleu2, bleu3, bleu3, bleu4, rouge_1, rouge_2, rouge_l, cider,spice
    best_epoch = 0
...
# Convert references to SPICE format
    ...
    spice = Spice()
    print("refs_spice_format:", refs_spice_format)
    print("res_spice_format:", res_spice_format)
    spice_score, _ = spice.compute_score(gts=refs_spice_format, res=res_spice_format)
