...
from models.MemoryTransformer import MemoryTransformer
...
parser.add_argument('--data_name', type=str, default='AB_model')
...
def main(args):
    ...
    if args.checkpoint is None:
        decoder = MemoryTransformer(num_layers, d_model, num_heads, dff, vocab_size, dropout=dropout)
