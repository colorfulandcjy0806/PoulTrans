...
class EncoderCNN(nn.Module):
    def __init__(self, encoded_image_size=14):
        ...
        good_model = models.shufflenet_v2_x1_0(weights=models.ShuffleNet_V2_X1_0_Weights.IMAGENET1K_V1)
    ...
    def forward(self, images):
        ...
        # out.shape = torch.Size([8, 14, 14, 464])
        return out
...
class AttnDecoderRNN(nn.Module):
    ...
    # 就改encoder_dim即可
    def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, encoder_dim = 464, dropout = 0.5):
