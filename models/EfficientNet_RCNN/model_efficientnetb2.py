...
class EncoderCNN(nn.Module):
    def __init__(self, encoded_image_size=14):
        ...
        good_model = models.efficientnet_b2(weights=models.EfficientNet_B2_Weights.DEFAULT)
...
class AttnDecoderRNN(nn.Module):
    ...
    # 就改encoder_dim即可
    def __init__(self, attention_dim, embed_dim, decoder_dim, vocab_size, encoder_dim=1408, dropout=0.5):
